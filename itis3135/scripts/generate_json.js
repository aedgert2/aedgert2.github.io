document.addEventListener("DOMContentLoaded", () => {
  // Create and add the Generate JSON button if it doesn't exist
  ...
  jsonBtn.addEventListener("click", () => {
    // Gather data from the form using your current IDs
    ...
    const image = "images/selfimage.jpg"; // static path
    ...
    // Build the links array (mapping to your IDs)
    const links = [
    ...
    const jsonData = {
      ...
      academicBackground,
      subjectBackground: "", // optional empty field
      primaryComputer: "", // optional empty field
      courses,
      links
    };

    // Turn it into formatted JSON
