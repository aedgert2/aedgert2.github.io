document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateIntro() {
    ...
    let imgSrc = "images/selfimage.jpg"; // default
   ...
   // Optional fields added as list items
if (funnyThing.trim() !== "") {
...
introHTML += `</ul>`; // close the list
    ...
    <a href="${document.getElementById("linkLinkedIn").value}">LinkedIn</a>
      ...
      <p>Page Built by <a href="cuttingedgedesign.co/">Cutting Edge Design</a> &copy; 2025</p>
    </footer>
  `;

    // Hide form and headings
  ...
  // Prevent default submission and generate intro
